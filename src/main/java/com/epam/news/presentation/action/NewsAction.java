...
import com.epam.news.presentation.Routes;
...
public class NewsAction extends MappingDispatchAction {
	 ...
	 * Create news.
	 * 
	 * Create or update news using service. Get news model from NewsForm.
	...
	public ActionForward create(ActionMapping mapping, ActionForm form,
		...
		if (isCancelled(request)) {
			return getBackNewsForward(request, mapping, Routes.LAST_PAGE, Routes.LAST_ID);
		}
	...
	public ActionForward locale(ActionMapping mapping, ActionForm form,
		...
		return getBackNewsForward(request, mapping, Routes.CURRENT_PAGE, Routes.CURRENT_ID);
	}
	...
	private ActionForward getBackNewsForward(HttpServletRequest request,
